    ...
    >
      <div className="md:min-w-[600px] md:max-w-[600px] md:min-h-[400px] md:max-h-[90vh] md:h-[650px] w-full min-h-full h-full bg-black md:rounded-3xl  overflow-y-scroll relative z-30">
        ...
        >
          ...
          <button
            onClick={sendPhoto}
            className="w-20 font-semibold text-sm rounded-2xl flex items-center justify-center h-8 text-black bg-white ml-auto transition-all hover:bg-[#D7DBDC] "
          >
            {loading ? (
        ...
        <div
          id="bannerSection"
          className="w-full h-[200px] flex items-center justify-center relative overflow-hidden bg-[#333639] "
        >
          <img
            id="bannerPhotoImg"
            src={user?.banner ?? Defbanner}
