        ...
        <div className="ml-auto">
          {followers.includes(`${currentUser.id}`) ? (
            <button
              ...
              onMouseLeave={() => setText("Takip ediliyor")}
              onClick={follow}
            ...
            <button
              onClick={follow}
              className="w-[87px] h-[32px] rounded-3xl bg-white flex items-center justify-center transition-all ml-auto hover:bg-[#EFF3F4] "
            >
              {fLoading ? (
                <div className="w-4 h-4 border-2 border-gray-600 border-t-[#1d9bf0] animate-spin rounded-full "></div>
              ) : (
