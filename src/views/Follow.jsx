    ...
    <main className="w-full flex items-start">
      <div className="min-w-full md:w-[990px] md:min-w-max relative">
        <div className="w-full flex items-end justify-end gap-10  ">
          <div
            id="tweets"
            className="border-l md:w-[592px] border-l-gray-500 border-r border-r-gray-500 border-opacity-50 self-start w-full flex flex-col items-center min-h-screen "
          >
            <div
              id="topbar"
              className="w-full flex flex-col h-[100px] items-start justify-start z-10 "
            >
              <div
              ...
              >
                <div
                  id="userInformation"
                  className="w-full h-[53px] items-center flex gap-6 px-4 "
                >
                  <div
                ...
                <div
                  id="menu"
                  className="flex items-start justify-start w-[85%] md:w-full h-[57px] "
                >
                  <div
                    onClick={() => navigate(`/${user.username}/followers`)}
                    className="w-full h-full px-4 flex items-center justify-center transition-all hover:bg-[#181818] cursor-pointer"
                  >
                    <span
                      className={`h-full ${
            ...
            >
              {loading ? (
                ...
                currentMode.map((id, index) => (
                  <FollowUser key={index} id={id} />
                ))
              )}
            </div>
          </div>
