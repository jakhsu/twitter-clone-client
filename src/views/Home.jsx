      ...
      <div className="min-w-full md:w-[990px] md:min-w-max relative">
        <div className="w-full flex items-end justify-end gap-10">
          ...
          >
            <div
              id="topbar"
              className="w-full relative h-[53px] flex items-center justify-center z-30"
            >
              <div
                className="flex items-center justify-between h-[53px] fixed w-[85%] md:w-[31%] px-4"
                style={{
